...
export default function CourseCard({ 
  ...
  return (
    <Link href={href}>
      <div className="group relative bg-white rounded-3xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-gray-200 hover:border-[#1199B6]/40 overflow-hidden">
        {/* Depth shadow layer */}
        ...
        <div className="flex items-start space-x-4 mb-4 relative z-10">
          {icon && (
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#1199B6] to-[#0e7a8f] flex items-center justify-center flex-shrink-0 shadow-lg shadow-[#1199B6]/30 group-hover:shadow-xl group-hover:shadow-[#1199B6]/40 group-hover:scale-110 transition-all duration-300">
              {icon}
            </div>
          )}
          {image && (
        ...
        <h3 className="text-xl font-bold text-[#0C1A2B] mb-2 group-hover:text-[#1199B6] transition-colors relative z-10">
          {title}
        </h3>
