  ...
  return (
    <Link href={href}>
      <div className="group bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 cursor-pointer h-full flex flex-col">
        ...
        <div className="relative h-48 bg-gradient-to-br from-[#0C1A2B] to-[#0a1625] overflow-hidden">
          {/* Abstract pattern background */}
          <div className="absolute inset-0 opacity-30">
            <svg className="w-full h-full" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M20 80 L50 80 L50 140 L20 140 Z" fill="#1199B6" opacity="0.3"/>
              <path d="M60 60 L90 60 L90 140 L60 140 Z" fill="#1199B6" opacity="0.3"/>
              <path d="M100 70 L130 70 L130 140 L100 140 Z" fill="#1199B6" opacity="0.3"/>
              <path d="M140 50 L170 50 L170 140 L140 140 Z" fill="#1199B6" opacity="0.3"/>
              <line x1="20" y1="80" x2="170" y2="80" stroke="#1199B6" strokeWidth="1" opacity="0.4"/>
              <line x1="20" y1="140" x2="170" y2="140" stroke="#1199B6" strokeWidth="1" opacity="0.4"/>
            </svg>
          </div>
          {/* Icon in center */}
          ...
          <div className="absolute bottom-3 left-3 w-7 h-7 bg-[#1199B6] rounded flex items-center justify-center shadow-lg">
            <span className="text-[#0C1A2B] font-bold text-xs">U</span>
          </div>
        </div>
        ...
        <div className="p-5 flex-1 flex flex-col">
          {/* Title */}
          <h3 className="text-base font-bold text-[#0C1A2B] mb-2 group-hover:text-[#1199B6] transition-colors line-clamp-2">
            {title}
          </h3>
          ...
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="flex items-center gap-1 bg-transparent">
              <svg className="w-3 h-3 text-[#1199B6]" fill="currentColor" viewBox="0 0 20 20">
              ...
              <span className="text-[10px] font-semibold text-[#1199B6] uppercase tracking-wide">NANODEGREE PROGRAM</span>
            </div>
